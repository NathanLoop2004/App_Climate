 ...
 const API_KEY = '68eced32006658951a4c9461553df01f';
  ...
  return (
    <div className='flex flex-col items-center'>
        ...
        {/* Datos de Grados */}
      <section className=" border-white w-[250px] mt-[-25px] mb-[15px] h-[120px] flex justify-center items-center flex-row">
      ...
      <section className=" border-white w-[260px] h-[55px] mb-[13px] flex justify-center items-center  ">
        <h1 className='text-[35px] text-[#a09fb1]'>{descripcion  !== "" ? descripcion : "Loading..."}</h1>
      </section>

     {/* Datos del dia */}
      <section className="text-[#a09fb1] mt-10 text-[13px]">
